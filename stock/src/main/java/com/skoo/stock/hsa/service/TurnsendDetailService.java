 ...
 */
@Component
public class  TurnsendDetailService extends BaseService<TurnsendDetail> {
	 ...
	 * @return
	 */
	public PageInfo<TurnsendDetail> queryPaged(Condition condition) {
		Assert.notNull(condition);
		Criteria c = condition.createCriteria(TurnsendDetail.class);
		c.add(Restrictions.between("code", "0", "700000"));
	...
	public Long saveOrUpdate(TurnsendDetail o) {
		Assert.notNull(o);
		Condition condition = new Condition();
		Criteria c = condition.createCriteria(TurnsendDetail.class);
		c.add(Restrictions.eq("code", o.getCode()));
		List<TurnsendDetail> list = super.query(condition);
