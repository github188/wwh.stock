...
public class TCPUtil {
	...
	/**
	  ...
	  public static Map<String, String> sendTCPRequest(String IP, int port, String reqData){
	    ...
	    try {
	      ...
	      byte[] b = Tools.hexStringToBytes(reqData);
	      for(int i = 0;i<b.length;i++){
	    	 LogUtil.i("cm_socket","发送报文------" +b[i]);
	      }
	      out.write(Tools.hexStringToBytes(reqData));
	      //LogUtil.i("cm_socket","发送报文------" +Tools.bytesToHexString(reqData.getBytes()));
	      out.flush();
	      /**
	       * 接收HTTP响应
	       */
