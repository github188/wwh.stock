package cn.hzstk.securities.sys.utils.json;
    ...
    public void writeAfter(Object bean) {
        for (Field field : bean.getClass().getDeclaredFields()) {
				...
				if (annotation != null
                    ...
                    Map<String, cn.hzstk.securities.sys.domain.Dict> map = dictService
							.getDictsByKey(key);
					if (map != null) {
						cn.hzstk.securities.sys.domain.Dict dic = map.get(value);
						if (dic != null) {
