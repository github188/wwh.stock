...
import cn.hzstk.securities.net.mapper.TigerDataMapper;
...
*/
@Component
public class  TigerDataService extends BaseService<TigerData,TigerDataMapper> {
    ...
    * @return
    */
    public List<TigerData> query(Map<String, String> paramMap) {
        Example example = new Example(TigerData.class);
    ...
    * @return
    */
    public Long saveOrUpdate(TigerData o) {
        Example example = new Example(TigerData.class);
        Example.Criteria criteria = example.createCriteria();
        criteria.andEqualTo("valid","1");
        criteria.andEqualTo("stockCode", o.getStockCode());

        List<TigerData> list = mapper.selectByExample(example);
