 ...
 */
@SuppressLint("NewApi")
public class MyCouponDeprecateAdapter extends BaseAdapter {
	...
	public MyCouponDeprecateAdapter(Context context,ArrayList<CouponBean> data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    	  ...
	    	  if(convertView == null){
		    		...
		    		convertView = inflater.inflate(R.layout.listview_coupon_deprecate, null);
	    	  ...
	    	  if("1".equals(bean.getLimitation())){//1-仅限交流电桩，2-仅限直流电装，3-不限充电桩
	    		  ...
	    		  itemHold.tv_type.setBackgroundResource(R.drawable.img_coupon_deprecate_type);
	    		  ...
	    		  if("2".equals(bean.getRule())){
	    			  ...
	    			  if(0 == Integer.valueOf(bean.getcCondition()) ){
	    				  ...
	    				  itemHold.tv_condition.setText(condition);
	    			  }
	    		  }
