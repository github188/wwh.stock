...
function tracert() {
    if (pgvIsPgvDomain()) {
        ...
        var e = escape(window.location.href)
            , t = "pj=1990&dm=gu.qq.com&url=" + Tcss.url + "&arg=" + Tcss.arg + "&rdm=" + Tcss.rdm + "&rurl=" + Tcss.rurl + "&rarg=" + Tcss.rarg + "&icache=" + Tcss.pgUserType + "&uv=" + "&nu=" + "&ol=" + "&loc=" + e + "&column=" + Tcss.column + "&subject=" + Tcss.subject + pgvGetNewRand() + "&rnd=" + Math.round(Math.random() * 1e5);
    ...
    tcss.prototype = {
        ...
        run: function() {
            ...
            e = (new Date).getTime(),
                ...
                this.url.unshift("http://pingfore.qq.com/pingd?"),
