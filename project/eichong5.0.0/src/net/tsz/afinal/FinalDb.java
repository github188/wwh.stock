...
public class FinalDb {
	 ...
	 * @param clazz
	 */
	public void creatTable(Context mContext,String tableName) {
		if(!tabIsExistByName(tableName)){
			/** 向数据中添加表 **/
	 ...
	 * @return
	 */
	public boolean tabIsExistByName(String tabName) {
	...
	private <T> List<T> findAllBySql(Class<T> clazz, String strSQL) {
		checkTableExist(clazz);
		//debugSql(strSQL);
		LogUtil.i("cm_socket SQL>>>>>> ", strSQL);
