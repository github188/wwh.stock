...
import cn.hzstk.securities.task.mapper.TaskFileMapper;
...
public class TaskFileService extends BaseService<TaskFile, TaskFileMapper> {
	...
	public List<TaskFile> selectTaskBidFiles(String taskId){
		return selectTaskFiles(taskId, "task-biddoc", null);
	}
