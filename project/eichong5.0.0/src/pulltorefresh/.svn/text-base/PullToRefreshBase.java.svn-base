...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public boolean pullsettins = true;
	public boolean pullsettins2 = true;
	...
	private void callRefreshListener() {
		if (null != mOnRefreshListener) {
			...
			if (mCurrentMode == Mode.PULL_FROM_START) {
				...
				if (isRefreshing()&&!pullsettins) {
					setState(State.RESET);
					mOnRefreshListener2.onPullUpToRefreshNoData(this);
				}else {
	...
	private void pullEvent() {
		...
		if (newScrollValue != 0 && !isRefreshing()) {
			...
			switch (mCurrentMode) {
				case PULL_FROM_END:
					mFooterLayout.onendPull(scale , pullsettins );
					break;
				case PULL_FROM_START:
				default:
					mHeaderLayout.onstartPull(scale , pullsettins2 );
					break;
			}
	...
	public static interface OnRefreshListener2<V extends View> {
		 ...
		 * the end, and released.数据
		 */
		public void onPullUpToRefresh(final PullToRefreshBase<V> refreshView);
		
		public void onPullUpToRefreshNoData(final PullToRefreshBase<V> refreshView);
