 ...
 *
 */
public class MyDeviceErrorGridViewAdapter extends BaseAdapter {
	private Context mContext;
	private String typename;
	private ArrayList<EquipmentBean> mdata;
	...
	public MyDeviceErrorGridViewAdapter(Context context,ArrayList<EquipmentBean> data) {
