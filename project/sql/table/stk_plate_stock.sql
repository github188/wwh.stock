...
-- ----------------------------
-- Table structure for stk_plate_stock
-- ----------------------------
DROP TABLE IF EXISTS `stk_plate_stock`;
CREATE TABLE `stk_plate_stock` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27256 DEFAULT CHARSET=utf8 COMMENT='板块股票代码关联';
