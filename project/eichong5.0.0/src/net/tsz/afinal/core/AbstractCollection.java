...
public abstract class AbstractCollection<E> implements Collection<E> {
     ...
     * each element {@code e} returned by the iterator is compared with the common_listview
     * {@code e == null}.
     *
     * @param object
     ...
     * then this common_listview is performed using {@code object.equals(e)}, otherwise
     ...
     * the specified {@code Collection}. If this common_listview is positive, then the {@code
     ...
     * This implementation iterates over this {@code Collection} and tests for each
     * element {@code e} returned by the iterator, whether it is contained in
     * the specified {@code Collection}. If this common_listview is negative, then the {@code
     * remove} method is called on the iterator. If the iterator does not
     * support removing elements, an {@code UnsupportedOperationException} is
     * thrown.
     *
