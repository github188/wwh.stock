...
public class HeadImageUtils {
	...
	public static final int GET_IMAGE_BY_CAMERA = 0xa1;
	public static final int GET_IMAGE_BY_GALLARY = 0xa2;
	public static final int CROP_IMAGE = 0xa3;
	public static Uri imageUriFromCamera ; 
	public static Uri cropImageUri;

	public static void openCameraImage(final Activity activity) {
		//imageUriFromCamera = createImagePathUri(activity);
		imageUriFromCamera = Uri.fromFile(new File(Environment
	...
	public static void openLocalImage(final Activity activity) {
		...
		activity.startActivityForResult(intent, GET_IMAGE_BY_GALLARY);
	}
	
	public static void cropImage(Activity activity, Uri srcUri) {
		HeadImageUtils.cropImageUri = HeadImageUtils.createImagePathUri(activity);
		int dp = 100;
	...
	private static Uri createImagePathUri(Context context) {
		...
		//Log.i("cm_photoPath", "生成的照片输出路径：" + imageFilePath.toString());
