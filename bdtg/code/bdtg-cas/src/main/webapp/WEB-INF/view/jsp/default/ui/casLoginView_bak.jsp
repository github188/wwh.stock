...
<div id="msg" class="errors">
  ...
  <div class="box" id="login" style="MARGIN-RIGHT: auto; MARGIN-LEFT: auto; float:none;">
			<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <!-- verifyCode -->  
                    <div class="row fl-controls-left" style="display: none">
	                    <label for="verifyCode" class="fl-label"><spring:message code="screen.welcome.label.verifycd" /></label>
	                    <div style="position: relative;">
	                      <input class="required" type="text" tabindex="3" id="verifyCode" size="4" name="verifyCode" autocomplete="off" style="width: 67px;"/>
	                      <div style="width: 100px;position: absolute; top:5px;left: 100px;">
	                      	<a href="javascript:void(0)" onclick="refresh();return false;">  
	                            <img id="vali" src="captcha.htm" style="height: 23px;width: 90px;"/>  
	                        </a>
	                      </div>
	                    </div>
