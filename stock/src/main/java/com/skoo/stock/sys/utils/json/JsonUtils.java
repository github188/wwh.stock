...
import com.skoo.core.utils.json.BaseProcessor;
import com.skoo.core.utils.json.DateJsonValueProcessor;
import com.skoo.core.utils.json.SqlDateProcessor;
...
public class JsonUtils extends com.skoo.core.utils.JsonUtils {

    protected static String[] EXCLUDES = {"start", "limit", "sort", "dir", "data"};
    protected static String[] EXCLUDES_API = {"cn.jp.us.en.ru"};

    /**
     * 对象转换成Json字符串
     *
     * @param o        将转换为Json字符串的对象，不可为<code>null<code>
