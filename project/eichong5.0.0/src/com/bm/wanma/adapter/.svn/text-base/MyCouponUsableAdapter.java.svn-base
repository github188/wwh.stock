 ...
 */
@SuppressLint("NewApi")
public class MyCouponUsableAdapter extends BaseAdapter {
	...
	public MyCouponUsableAdapter(Context context,ArrayList<CouponBean> data) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    	  ...
	    	  if(convertView == null){
		    		...
		    		convertView = inflater.inflate(R.layout.listview_coupon_usable, null);
