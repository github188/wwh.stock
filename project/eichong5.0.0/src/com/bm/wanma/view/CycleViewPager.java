...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	private ArrayList<ImageCarouselBean> carouselBeans;
	...
	public void setData(List<ImageView> views, ArrayList<ImageCarouselBean> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, ArrayList<ImageCarouselBean> list, ImageCycleViewListener listener, int showPosition) {
	 ...
	 * 设置指示器居中，默认指示器在右方
	 */
	public void setIndicatorCenter(boolean b) {
				...
				v.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if (carouselBeans.size()==1) {
							mImageCycleViewListener.onImageClick(null, currentPosition, v);
						}else {			
							mImageCycleViewListener.onImageClick(null, currentPosition, v);
						}
					}
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(ImageCarouselBean carouselBean, int postion, View imageView);
	}
}