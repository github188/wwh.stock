 ...
 *
 */
public class PoiAdcodeAdapter extends BaseAdapter {
	private Context mContext;
	private ArrayList<PoiAdcodeBean> mdata;
	private LayoutInflater inflater;
	private PoiAdcodeBean itemBean;
	
	public PoiAdcodeAdapter(Context context,ArrayList<PoiAdcodeBean> data) {
