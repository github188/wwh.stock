 ...
 */
public abstract class BaseTopTabFragment<Bind extends ViewDataBinding> extends BaseFragment<Bind>
        implements TabLayoutView.TabLayoutCallBack{

    public TabLayoutView tabLayoutView;
    @Override
    public final void initViewAndData(){
        tabLayoutView = new TabLayoutView(getChildFragmentManager(), this);
    }
