package com.bm.wanma.view.wheelview;
...
public class WheelMain {
	...
	//private static int START_YEAR = 1915, END_YEAR = 2015;
	...
	public WheelMain(View view) {
		...
		this.view = view;
		hasSelectTime = false;
		this.END_YEAR = Calendar.getInstance().get(Calendar.YEAR);
		this.START_YEAR = END_YEAR-100;
		setView(view);
	}
