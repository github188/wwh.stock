...
(function(d) {
    ...
    function w(g, a, b, c, e, f, d, i) {
        var h = [];
        return f > e && f - e > n / 2 + 1.0E-4 ? (h = h.concat(w(g, a, b, c, e, e + n / 2, d, i)),
            h = h.concat(w(g, a, b, c, e + n / 2, f, d, i))) : f < e && e - f > n / 2 + 1.0E-4 ? (h = h.concat(w(g, a, b, c, e, e - n / 2, d, i)),
            h = h.concat(w(g, a, b, c, e - n / 2, f, d, i))) : (h = f - e,
            ["C", g + b * m(e) - b * B * h * l(e) + d, a + c * l(e) + c * B * h * m(e) + i, g + b * m(f) + b * B * h * l(f) + d, a + c * l(f) - c * B * h * m(f) + i, g + b * m(f) + d, a + c * l(f) + i])
    }
    function C(g) {
        if (this.chart.is3d()) {
    ...
    d.SVGRenderer.prototype.cuboid = function(g) {
        var a = this.g()
            , g = this.cuboidPath(g);
        a.front = this.path(g[0]).attr({
            zIndex: g[3],
            "stroke-linejoin": "round"
        }).add(a);
        a.top = this.path(g[1]).attr({
            zIndex: g[4],
            "stroke-linejoin": "round"
        }).add(a);
        a.side = this.path(g[2]).attr({
            zIndex: g[5],
            "stroke-linejoin": "round"
        }).add(a);
        ...
        ;
        a.attr = function(a) {
            a.shapeArgs || a.x ? (a = this.renderer.cuboidPath(a.shapeArgs || a),
                this.front.attr({
                    d: a[0],
                    zIndex: a[3]
                }),
        ...
        a.animate = function(a, c, e) {
            a.x && a.y ? (a = this.renderer.cuboidPath(a),
                this.front.attr({
                    zIndex: a[3]
                }).animate({
                    d: a[0]
    ...
    d.SVGRenderer.prototype.arc3d = function(g) {
        ...
        a.animate = function(a, b, c) {
            a.end || a.start ? (this._shapeArgs = this.shapeArgs,
    ...
    d.SVGRenderer.prototype.arc3dPath = function(d) {
        ...
        var v = i * l(k)
            ...
            , a = ["M", a + r * d, b + s * z, "L", a + r * d + v, b + s * z + u, "L", a + p * d + v, b + j * z + u, "L", a + p * d, b + j * z, "Z"]
            , b = l((c + e) / 2)
            , c = l(c)
            , e = l(e);
        return {
            ...
            zTop: f,
            out: h,
            zOut: Math.max(b, c, e) * f,
            inn: k,
            zInn: Math.max(b, c, e) * f,
            side1: o,
            zSide1: c * f * 0.99,
            side2: a,
            zSide2: e * f * 0.99
    ...
    d.wrap(d.Axis.prototype, "render", function(d) {
        ...
        if (this.chart.is3d()) {
            var a = this.chart
                ...
                , e = c.alpha
                , f = c.beta * (a.yAxis[0].opposite ? -1 : 1)
                , j = c.frame
                , i = j.bottom
                , h = j.back
                , j = j.side
            ...
            if (this.horiz)
                this.axisLine && this.axisLine.hide(),
                    ...
                    this.bottomFrame ? this.bottomFrame.animate(f) : this.bottomFrame = b.cuboid(f).attr({
                        fill: i.color,
    ...
    d.wrap(d.Axis.prototype, "getPlotLinePath", function(d) {
        ...
        var a = [{
            ...
            , f = b.options.inverted ? c.alpha : c.beta;
    ...
    d.seriesTypes.columnrange && d.wrap(d.seriesTypes.columnrange.prototype, "drawPoints", C);
    d.wrap(d.seriesTypes.column.prototype, "drawPoints", C);
    y = d.getOptions();
    y.plotOptions.cylinder = d.merge(y.plotOptions.column);
    y = d.extendClass(d.seriesTypes.column, {
        type: "cylinder"
    });
            ...
            d.each(a.data, function(b) {
                ...
                if (b.y)
                    c.z = k,
                        ...
                        c = (c.end + c.start) / 2,
                        b.slicedTranslation = {
                            translateX: A(m(c) * a.options.slicedOffset * m(i * t)),
                            translateY: A(l(c) * a.options.slicedOffset * m(i * t))
                        }
            })
        }
    });
    d.wrap(d.seriesTypes.pie.prototype.pointClass.prototype, "haloPath", function(d) {
        return this.series.chart.is3d() ? [] : d.call(this)
    });
    ...
    d.wrap(d.seriesTypes.scatter.prototype, "translate", function(g) {
        g.apply(this, [].slice.call(arguments, 1));
        if (this.chart.is3d()) {
            var a = this.chart
    ...
    if (d.VMLRenderer)
        d.setOptions({
            ...
            d.VMLRenderer.prototype.arc3d = function(g) {
