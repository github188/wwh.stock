-- ----------------------------
-- Table structure for stk_rx_his
-- ----------------------------
DROP TABLE IF EXISTS `stk_rx_his`;
CREATE TABLE `stk_rx_his` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='沪深A股日线历史';
