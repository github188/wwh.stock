-- ----------------------------
-- Table structure for stk_rx_data
-- ----------------------------
DROP TABLE IF EXISTS `stk_rx_data`;
CREATE TABLE `stk_rx_data` (
  ...
  `mavol1` varchar(12) DEFAULT NULL COMMENT '5日量',
  `mavol2` varchar(12) DEFAULT NULL COMMENT '10日量',
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='沪深A股日线';
