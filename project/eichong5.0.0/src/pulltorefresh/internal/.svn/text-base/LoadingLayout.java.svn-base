...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout{
	...
	public final void onstartPull(float scaleOfLayout,boolean pullsettins2) {

		if(pullsettins2){
			if(mInnerLayout.getVisibility()==View.GONE){
	...
	public final void onendPull(float scaleOfLayout,boolean pullsettins) {
		if(pullsettins){
			if(mInnerLayout.getVisibility()==View.GONE){
				mInnerLayout.setVisibility(View.VISIBLE);
			}
