...
/**
 * Created by yangchun on 2016/12/5.
 */
...
public class ZipUtils {
     ...
     * @throws Exception
     */
    public static ArrayList<String> UnZipFolder(String zipFileString, String outPathString) throws Exception {
        ZipInputStream inZip = new ZipInputStream(new FileInputStream(zipFileString));
        ZipEntry zipEntry;
        String szName = "";
        ArrayList<String> entryName = new ArrayList<>();
