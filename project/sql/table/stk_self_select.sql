-- ----------------------------
-- Table structure for stk_self_select
-- ----------------------------
DROP TABLE IF EXISTS `stk_self_select`;
CREATE TABLE `stk_self_select` (
  `id` bigint(10) NOT NULL AUTO_INCREMENT,
  `stock_code` varchar(6) NOT NULL COMMENT '代码',
  `stock_name` varchar(30) DEFAULT NULL COMMENT '名称',
  `dt` varchar(10) DEFAULT NULL COMMENT '日期或组合编码',
  ...
  `average_price` varchar(10) DEFAULT NULL COMMENT '均价',
  ...
  `amount` varchar(10) DEFAULT NULL COMMENT '总金额',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code_index` (`stock_code`,`dt`)
) ENGINE=InnoDB AUTO_INCREMENT=2779 DEFAULT CHARSET=utf8 COMMENT='沪深A股自选';
