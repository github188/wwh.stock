...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		loadFull = (TextView) footer.findViewById(R.id.pull_loadFull);
		noData = (TextView) footer.findViewById(R.id.pull_noData);
		more = (TextView) footer.findViewById(R.id.pull_more);
		loading = (ProgressBar) footer.findViewById(R.id.pull_loading);
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		LogUtil.i("cm——", "onScrollStateChanged"+scrollState);
	...
	private void whenMove(MotionEvent ev) {
		...
		//int space = Math.abs(tmpY - startY);
		...
		case RELEASE:
			topPadding(topPadding);
			int header = headerContentHeight + SPACE;
			LogUtil.i("cm_", "space"+space+"header"+ header);
	...
	// 用来计算header大小的。因为header的初始高度就是0,貌似可以不用。
