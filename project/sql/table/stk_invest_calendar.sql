...
-- ----------------------------
-- Table structure for stk_invest_calendar
-- ----------------------------
DROP TABLE IF EXISTS `stk_invest_calendar`;
CREATE TABLE `stk_invest_calendar` (
  ...
  `invest_type` varchar(50) DEFAULT NULL COMMENT '类型说明',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `stock_index` (`dt`,`stock_code`,`invest_type`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='沪深股票投资日历';
