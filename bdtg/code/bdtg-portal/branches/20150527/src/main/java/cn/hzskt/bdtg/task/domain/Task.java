...
public class Task extends BaseDomain {
	...
	/** 
	 * 任务状态 0、未付款 1、待审核 2、投标中 3、选标中  
	 * 4、工作中  p4、中标 s4、合同确认
	 * 7、冻结 8、结束 9、失败 10、审核失败 
	 */
	...
	public Long getProgressVal() {
		return progressVal;
	}

	public void setProgressVal(Long progressVal) {
	...
	public String getYzcn() {
		return yzcn;
	}

	public void setYzcn(String yzcn) {
		this.yzcn = yzcn;
	}

	public String getQtfw() {
		return qtfw;
	}

	public void setQtfw(String qtfw) {
		this.qtfw = qtfw;
	}
